  ...
  return (
    <div className="min-w-full min-h-full ">
        ...
        <div className="xl:px-20 xl:pt-32 xl:pb-24 px-10 pt-24 pb-8 flex justify-between items-center">
            <h1 className="xl:text-5xl text-2xl font-semibold xl:font-medium text-darkBlue"
            ref={studyRef}
            >Case Studies</h1>
        ...
        {STUDIES.map((item,index) => (
              ...
              <div className="h-[120px] bg-gray-100 group-hover:bg-white flex items-center justify-center">
                  <p className="text-lg w-2/3 text-center pt-2 pb-0 text-darkBlue ">
                    {item.label}
                  </p>
          </div>          
          </div>
        ...
        <div className="border border-gray-800 my-10 h-1 mx-10 relative overflow-hidden">
            <div className="bg-teal h-2 absolute inset-x-0 transition-all duration-300 "
            style={{
                width: `${progressWidth}%`
            }}
            />
