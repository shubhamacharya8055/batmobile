...
import { HI_TECH_SERVICES } from "@/lib/constants";
import { HI_TECH_SERVICES_INFORMATION } from "@/lib/constants";
  ...
  return (
    <div className="min-w-full min-h-full">
      ...
      <div className="min-w-full min-h-full xl:px-14 px-10 py-14">
        <Service />
        <ServiceHeading description={`Powering the Future of Digital Enterprises`}
        title={`Hi Tech`} />
        <HorizontalScroll data={HI_TECH_SERVICES} />
        <Information data = {HI_TECH_SERVICES_INFORMATION} />
      </div>
      <Capabilities />
      <Footer />
    </div>
