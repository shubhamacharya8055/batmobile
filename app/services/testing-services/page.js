...
import { TESTING_SERVICES } from "@/lib/constants";
import { TESTING_SERVICES_INFORMATION } from "@/lib/constants";
  ...
  return (
    <div className="min-w-full min-h-full">
      ...
      <div className="min-w-full min-h-full xl:px-14 px-10 py-14">
        <Service />
        <ServiceHeading description={`Accelerating the development of end-to-end operations for your business.`}
        title={`Testing Services`} />
        <HorizontalScroll data={TESTING_SERVICES} />
        <Information data = {TESTING_SERVICES_INFORMATION} />
      </div>
